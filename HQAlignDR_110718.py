...
print("Welcome to HQAlign_DR_October_14__2018")
...
##        LogFileName=join(LogFileDir,'HQAlignLog.txt')
    ...
    ReferenceFile=open(ReferenceFileName,mode="rU")
...
##                    ReadName1=S[1:]
        ...
        if SimpleOutput and SimpleOutputSum:
            SOL1=zip(SimpleOutputD.keys(),SimpleOutputD.values())
        ...
        if PileUp:
            ...
            for X1 in range(len(ReadMatches_Sense)):
                ...
                if ReadMatches_AntiSense:
                    ...
                    X2=ReadMatches_AntiSense[X1].keys()
                    if X2: X2.sort(key=lambda xx:(xx[1],xx[0]))
                    X4=[]
                    X5=[]
                    for X3 in X2:
